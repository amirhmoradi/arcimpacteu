...
<div class="not-prose mb-12 grid items-center gap-8 sm:grid-cols-[minmax(0,200px)_1fr] sm:gap-10 md:grid-cols-[minmax(0,220px)_1fr] md:gap-12 lg:grid-cols-[minmax(0,240px)_1fr] lg:gap-14">
  <figure class="m-0 w-full max-w-[240px] shrink-0">
    <img src="{{ '/images/arcimpact/emmanuel-lecuyer.jpg' | url }}" alt="Portrait d’Emmanuel Lécuyer" width="240" height="243" class="w-full rounded-xl object-cover shadow-md" loading="eager" />
  </figure>
  <div class="min-w-0 pt-0 sm:pt-1">
    <p class="m-0 text-base leading-relaxed text-gray-800 md:text-lg"><strong>Emmanuel Lécuyer</strong> est le fondateur et le pilier pédagogique d’<strong>Arc IMPACT</strong>. Entraîneur <strong>diplômé d’État</strong>, il partage depuis plus de vingt ans une même obsession : rendre le tir à l’arc <strong>exigeant, lisible et transmissible</strong> — du club au plus haut niveau international.</p>
  </div>
</div>
